...
from .power import set_power, request_current_state
...
from .oscillation import set_oscillation_angles, stop_oscillation, set_oscillation_width, set_oscillation_direction
